		...
		process: function(o){
			...
			if(!this.angles){
				...
				if(typeof o.run.data[0] == "number"){
					this.angles = df.map(df.scanl(o.run.data, (a, b) => a + b, 0),
						function(x) { return x * 2 * Math.PI / this }, df.foldl(o.run.data, (a, b) => a + b, 0));
				}else{
					this.angles = df.map(df.scanl(o.run.data, (a, b) => a + b.y, 0),
						function(x) { return x * 2 * Math.PI / this }, df.foldl(o.run.data, (a, b) => a + b.y, 0));
				}
